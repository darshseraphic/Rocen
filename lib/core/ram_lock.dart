...
class _Libc {
  ...
  static final _MlockDart mlock =
      _lib.lookupFunction<_MlockNative, _MlockDart>('mlock');
  static final _MlockDart munlock =
      _lib.lookupFunction<_MlockNative, _MlockDart>('munlock');
}
